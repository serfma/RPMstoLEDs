// Serfma comments
// ESP IDF is based in C, had no fucking idea until now
// So this example is in C, and it's based on a library called
// ESP32-FreqCount and this works to measure the frequency range
// that we're interested in.
//
// HOWEVER THE FUCKING FASTLED LIBRARY TO CONTROL OUR LEDS IS IN C++
// AND AS OF 11/18/2020 2:59PM I HAVE NO FUCKING IDEA HOW TO DO BLACK MAGIC
// AND MAKE THIS WORK
...
{
	// So here's the callback that gets the frequency
	// Basically we need to use this to then tell an LED to light up
